...
unsigned long
OscUtils::messageId( const osc::ReceivedMessage& pOscMessage ) throw (Exception)
{
    osc::ReceivedMessage::const_iterator argIter = pOscMessage.ArgumentsBegin();
...
OscUtils::createMessage( const osc::ReceivedMessage& pReceivedMessage ) throw (Exception)
{
...
OscUtils::createMultiOscMessage( const osc::ReceivedMessage& pReceivedMessage ) throw (Exception)
{
...
void
OscUtils::updateMultiOscMessage( const osc::ReceivedMessage& pReceivedMessage, std::shared_ptr< MultiOscMessage> pMultiOscMessage ) throw (Exception)
{
    if( isMultiOscMessage(pReceivedMessage) == false )  throw Exception("OSC Error: ReceivedMessage does not form part of a MultiOscMessage", __FILE__, __FUNCTION__, __LINE__);
...
OscUtils::createPacketStream( std::shared_ptr<OscMessage> pMessage ) throw (Exception)
{
    try
    {
...
OscUtils::createPacketStreams( std::shared_ptr<MultiOscMessage> pMultiOscMessage ) throw (Exception)
{
    try
    {
...
std::shared_ptr<MultiOscMessage>
OscUtils::splitMessage( std::shared_ptr<OscMessage> pMessage ) throw (Exception)
{
    try
    {
...
std::shared_ptr<OscMessage>
OscUtils::mergeMessage( std::shared_ptr<MultiOscMessage> pMultiMessage ) throw (Exception)
{
