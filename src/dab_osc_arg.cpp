...
template<>
_OscArg*
OscArg<std::string>::copy(unsigned int pStartIndex, unsigned int pValueCount) const throw (Exception)
{
...
template<>
void
OscArg<std::string>::append(const _OscArg& pArg) throw (Exception)
{
