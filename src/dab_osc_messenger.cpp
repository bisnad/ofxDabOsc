...
OscMessenger::sender( const std::string& pSenderName ) throw (Exception)
{
    try
    {
...
const std::string&
OscMessenger::senderIP( const std::string& pSenderName ) const throw (Exception)
{
    try
    {
...
unsigned int
OscMessenger::senderPort( const std::string& pSenderName ) const throw (Exception)
{
    try
    {
...
std::shared_ptr<OscSender>
OscMessenger::addSender( std::shared_ptr<OscSender> pSender) throw (Exception)
{
    try
    {
...
std::shared_ptr<OscSender>
OscMessenger::createSender(const std::string& pSenderName, const std::string& pReceiverIP, unsigned int pReceiverPort) throw (Exception)
{
...
void
OscMessenger::removeSender(const std::string& pSenderName) throw (Exception)
{
    try
    {
...
OscMessenger::receiver( const std::string& pReceiverName ) throw (Exception)
{
    try
    {
        mReceivers[pReceiverName];
    }
    catch (Exception& e)
    {
...
unsigned int
OscMessenger::receiverPort( const std::string& pReceiverName ) const throw (Exception)
{
    try
    {
        mReceivers[pReceiverName]->port();
    }
    catch (Exception& e)
    {
        e += Exception("OSC ERROR: receiver with name " + pReceiverName + " not found", __FILE__, __FUNCTION__, __LINE__ );
...
std::shared_ptr<OscReceiver>
OscMessenger::addReceiver( std::shared_ptr<OscReceiver> pReceiver) throw (Exception)
{
    try
    {
...
std::shared_ptr<OscReceiver>
OscMessenger::createReceiver(const std::string& pReceiverName, unsigned int pListeningPort) throw (Exception)
{
...
void
OscMessenger::removeReceiver(const std::string& pReceiverName) throw (Exception)
{
    try
    {
...
void
OscMessenger::registerListener( const std::string& pReceiverName, std::shared_ptr<OscListener> pListener ) throw (Exception)
{
    try
    {
...
void
OscMessenger::send( const std::string& pSenderName, std::shared_ptr<OscMessage> pMessage) throw (Exception)
{
    try
    {
