...
public:
     ...
     */
    std::shared_ptr<OscSender> sender( const std::string& pSenderName ) throw (Exception);
    ...
    /**
     ...
     \exception Exception sender not found
     */
    const std::string& senderIP( const std::string& pSenderName ) const throw (Exception);
     ...
     */
    unsigned int senderPort( const std::string& pSenderName ) const throw (Exception);
     ...
     */
    std::shared_ptr<OscSender> addSender( std::shared_ptr<OscSender> pSender) throw (Exception);
     ...
     */
    std::shared_ptr<OscSender> createSender(const std::string& pSenderName, const std::string& pReceiverIP, unsigned int pReceiverPort) throw (Exception);
     ...
     */
    virtual void removeSender(const std::string& pSenderName) throw (Exception);
     ...
     */
    std::shared_ptr<OscReceiver> receiver( const std::string& pReceiverName ) throw (Exception);
    ...
    /**
     ...
     \exception Exception receiver not found
     */
    unsigned int receiverPort( const std::string& pReceiverName ) const throw (Exception);
     ...
     */
    std::shared_ptr<OscReceiver> addReceiver( std::shared_ptr<OscReceiver> pReceiver) throw (Exception);
     ...
     */
    std::shared_ptr<OscReceiver> createReceiver(const std::string& pReceiverName, unsigned int pListeningPort) throw (Exception);
     ...
     */
    virtual void removeReceiver(const std::string& pReceiverName) throw (Exception);
    ...
    /**
     ...
     \exception Exception receiver not found
     */
    void registerListener( const std::string& pReceiverName, std::shared_ptr<OscListener> pListener ) throw (Exception);
     ...
     */
    void send( const std::string& pSenderName, std::shared_ptr<OscMessage> pMessage) throw (Exception);
