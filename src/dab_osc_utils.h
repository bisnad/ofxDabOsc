...
#pragma mark OscUtils definiton
    ...
    public:
        ...
        unsigned long messageId( const osc::ReceivedMessage& pOscMessage ) throw (Exception);
        ...
        std::shared_ptr<osc::OutboundPacketStream> createPacketStream( std::shared_ptr<OscMessage> pMessage ) throw (Exception);
        std::vector< std::shared_ptr<osc::OutboundPacketStream> > createPacketStreams( std::shared_ptr<MultiOscMessage> pMultiOscMessage ) throw (Exception);
        
        std::shared_ptr< OscMessage > createMessage( const osc::ReceivedMessage& pReceivedMessage ) throw (Exception);
        std::shared_ptr< MultiOscMessage > createMultiOscMessage( const osc::ReceivedMessage& pReceivedMessage ) throw (Exception);
        void updateMultiOscMessage( const osc::ReceivedMessage& pReceivedMessage, std::shared_ptr< MultiOscMessage > pMultiOscMssage ) throw (Exception);
        
        std::shared_ptr<MultiOscMessage> splitMessage( std::shared_ptr<OscMessage> pMessage ) throw (Exception);
        std::shared_ptr<OscMessage> mergeMessage( std::shared_ptr<MultiOscMessage> pMultiMessage ) throw (Exception);
